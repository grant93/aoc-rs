...
fn count_orbits(map: &HashMap<String, String>) -> (HashMap<&String, HashSet<&String>>, u32) {
    ...
    for k in map.keys() {
        ...
        path_map.insert(k, set);
    }
    (path_map, count)
}

// Rather than performing a search, take the symmetric difference of the
// two sets.
...
mod tests {
    ...
    fn partone_test(#[case] input: &str, #[case] expected1: u32, #[case] expected2: u32) {
        let (first, second) = run(input.to_string());
